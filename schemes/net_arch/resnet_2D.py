...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv2d(64, 64, kernel_size=(7, 1), stride=(3, 1), padding=(3, 0), bias=False)
        self.bn1 = nn.BatchNorm2d(64)

        self.relu = nn.ReLU(inplace=True)
        self.maxpool = nn.MaxPool2d(kernel_size=(7, 1), stride=(3, 1), padding=(3, 0))
        ...
        self.avgpool = nn.AvgPool2d((6, 1), stride=1)
...
if __name__ == "__main__":
    ...
    input = torch.randn((64, 3, 16, 1140, 1))  # B x C x F x W x H
...
#     import torch
#
#     input = torch.randn((1, 3, 16, 224, 224)).cuda()  # B x C x F x W x H
#
