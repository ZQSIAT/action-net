...
def set_argparse_opts(args):
    ...
    #
    # parser.add_argument('--is_depth_clip', default=dataset_args["is_depth_clip"],
    #                     action="store_false", help="using depth clipped maps")
    ...
    # todo: numworks
    num_workers = len(cuda_args["gpu_card"].split(",")) * 8
